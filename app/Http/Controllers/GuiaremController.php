...
class GuiaremController extends Controller
{
    /**
    ...
    */
    ...
    public function index(Request $request)
    {
        ...
        ->addColumn('action', function($row){
           ...
           $btn = ' <a href="javascript:void(0)" data-toggle="tooltip"  data-id="'.$row->id.'" data-original-title="Delete" class="btn btn-secondary btn-sm deleteguia"><i class="fas fa-eye"></i></a>';
            return $btn;
        })
        ->rawColumns(['action'])
        ->make(true);
        ...
        return view('remguias/index',compact('distritos','servicios','agentes','clientes','remitentes','estados','fpagos','ultid'));
    }
    ...
    */
    ...
    ['fecha' => $request->fecha,'guia' => $request->guia,'id_servicio' => $request->id_servicio,'id_cliente' => $request->id_cliente,'id_remitente' => $request->id_remitente,'id_fpago' => $request->id_fpago,'monto' => $request->monto,'smonto' => $request->smonto, 'hdesde' => $request->hdesde,'hhasta' => $request->hhasta,'obsguia' => $request->obsguia,'id_estado' => $request->estado]);
