...
class ServicioController extends Controller
{
    ...
    */
    ...
    ->addColumn('action', function($row){
       $btn = '<a href="javascript:void(0)" data-toggle="tooltip"  data-id="'.$row->id.'" data-original-title="Edit" class="edit btn btn-secondary btn-sm editservicio"><i class="fas fa-eye"></i></a>';
