...
class GuiaController extends Controller
{
    ...
    */
    ...
    public function index(Request $request)
    {
        ...
        $data = Guia::with('clientes_pk','remitentes_pk','estados_pk')->get();
        ...
        return view('admguias/index',compact('distritos','servicios','agentes','clientes','remitentes','estados','fpagos','ultid'));
    }
    ...
    */
    ...
    ['fecha' => $request->fecha,'guia' => $request->guia,'id_servicio' => $request->id_servicio,'id_cliente' => $request->id_cliente,'id_remitente' => $request->id_remitente,'id_fpago' => $request->id_fpago,'monto' => $request->monto,'smonto' => $request->smonto, 'hdesde' => $request->hdesde,'hhasta' => $request->hhasta,'obsguia' => $request->obsguia,'id_agente' => $request->id_agente, 'id_estado' => $request->id_estado,'fentrega' => $request->fentrega,'obsentrega' => $request->obsentrega]);
