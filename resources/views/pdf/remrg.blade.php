...
<div class="container">
  ...
  <h3 style="text-align: left">Remitente:   {{ $guias[0]->remitente }} </h3>
...
@endphp
 ...
 <td>
  ...
  <div class="total">Total  a depositar --> <strong>{{(number_format($totalm,2))}}</strong> </div>
  <div class="total">Total  servicio    --> <strong>{{(number_format($totals,2))}}</strong>  </div>
  <div class="total">Total  cobrado     --> <strong>{{(number_format($totalc,2))}}</strong>  </div>
