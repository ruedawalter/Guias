  ...
  <div class="container" style="width:100%">
    ...
    {{-- <div class="card"> --}}
      <div class="card-body">
        ...
        <hr>
        <div class="col clearfix">
          <span class="float-left"><h3><i class="fas fa-motorcycle"></i>   Agente: {{Auth::user()->name}}</h3></span>
        </div>
      ...
      <hr>
        <div class="card-body">
          <div class="card-header">
            <div class="col clearfix" >
                  <span class="float-left" style="margin: 3px;"><a href="javascript:void(0)" id="reporteag" class ="btn btn-sm btn-primary" alt="Reporte Guias Agente"> <i class="fas fa-print"></i> <i class="fas fa-motorcycle"></i>  Reporte Guias Agente</a> </span>
                ...
                <form id="guiaForm" name="guiaForm" class="form-horizontal">
                   ...
                   @endif
                    ...
                    <div class="form-group">
                          <div class="col clearfix">
                            <span class="float-left" style = "width:40%"><label  for="fecha" >Fecha :</label>
                        ...
                        {{-- </div> --}}
                        {{-- <div class="col clearfix"> --}}
                            <span class="float-right" style = "width:40%"><label  for="id_servicio" >Servicio :</label>
                        ...
                        <div class="col clearfix">
                          ...
                          <p></p>
                          <div class="col clearfix">
                          <span class="float-rigth" style = "width:100%"><label name="dircli" id="dircli"></label></span>
                          </div>
                          <div class="col clearfix">
                          <span class="float-left" style = "width:100%"><label name="telcli" id="telcli"></label></span>
                          <span class="float-left" style = "width:100%"><label name="celcli" id="celcli"></label></span>
                          </div>
                          <p></p>
                          <hr>
                          <div class="col clearfix">
                          ...
                          <div class="col clearfix">
                           <span class="float-left" style = "width:100%"><label name="dirrem" id="dirrem"></label></span>
                          </div>
                          <div class="col clearfix">
                          <span class="float-left" style = "width:100%"><label name="telrem" id="telrem"></label></span>
                          <span class="float-left" style = "width:100%"><label name="celrem" id="celrem"></label></span>
                          </div>
                          <p></p>
                          <hr>
                          ...
                          <p></p>
                          <div class="col clearfix">
                            <span style = "width:100%"><label  for="id_fpago" >Forma de Pago :</label>
                          ...
                          <div class="col clearfix">
                            ...
                            <span class="float-left" style = "width:100%"><label  for="obsguia" >Observaciones:</label>
                          ...
                          <hr>
                          <div class="col clearfix">
                            <span style = "width:60%"><label  for="id_estado" >Status :</label>
                          ...
                          <p></p>
                          <div class="col clearfix">
                            <span style = "width:65%"><label  for="id_agente" >Agente :</label>
                          ...
                          <div class="col clearfix">
                            ...
                            <span class="float-right" style = "width:55%"><label  for="obsentrega" >Observaciones:</label>
                   ...
                   @endif
                    <div class="form-group">
                        ...
                        <div class="col clearfix">
                          ...
                          <p></p>
                          <div class="col clearfix">
                          <span class="float-rigth"><label  id="dirrem1"></label></span>
                          </div>
                          <div class="col clearfix">
                          <span class="float-rigth"><label id="telrem1"></label></span>
                          <span class="float-rigth"><label id="celrem1"></label></span>
                          </div>
                          <p></p>
                          <hr>
  ...
  <div class="modal fade " id="PdfGuiasag" aria-hidden="true" style="overflow-y: scroll;">
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content col-lg-12 col-md-8  col-sm-4 mx-auto">
            ...
            <div class="modal-body  mx-auto">
                <form id="PdfForma" name="PdfForma" class="form-horizontal" method="POST" action="{{ route('PdfguiaAg') }}">
  ...
  $(function () {
    ...
    var table = $('.data-table').DataTable({
        ...
        columns: [
            ...
            {data: 'celc', name: 'celc'},
            {data: 'direccionc', name: 'direccionc'},
    ...
    $('body').on('click', '.editguia', function () {
      ...
      $.get("{{ route('aguias.index') }}" +'/' + guia_id +'/edit', function (data) {
...
$('body').on('click', '.deleteguia', function () {
    ...
    $('#id_cliente').change(function(){
        ...
        $.ajax({
            url : "{{ route('aguias.bRemitente') }}"+"/"+cod+"/"+id,
            // data : {id:id},
            type : 'GET',
            dataType : 'json',
            success : function(data) {
